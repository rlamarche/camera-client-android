...
public class CaptureStopAsyncTask extends AsyncTask<Void, Void, Void> {

    private CameraApi mCameraApi = new CameraApi();

    private FullscreenActivity mActivity;

    public CaptureStopAsyncTask(FullscreenActivity mActivity) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        mActivity.setIsRecording(false);
    }
}
