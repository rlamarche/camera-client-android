...
public class LiveviewStopAsyncTask extends AsyncTask<Void, Void, Void> {

    private CameraApi mCameraApi = new CameraApi();

    private FullscreenActivity mActivity;

    public LiveviewStopAsyncTask(FullscreenActivity mActivity) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            mActivity.disableLiveview();
            mCameraApi.liveviewStopPost();
