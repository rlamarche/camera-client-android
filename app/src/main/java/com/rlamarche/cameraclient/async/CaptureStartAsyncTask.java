...
public class CaptureStartAsyncTask extends AsyncTask<Void, Void, Void> {

    private CameraApi mCameraApi = new CameraApi();

    private FullscreenActivity mActivity;

    public CaptureStartAsyncTask(FullscreenActivity mActivity) {
