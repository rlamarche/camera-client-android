            ...
            public Observable<MjpegInputStream> call() {
                try {
                    ...
                    switch (type) {
                        ...
                        case DEFAULT:
                            return Observable.<MjpegInputStream>just(new MjpegInputStreamDefault(inputStream));
                        case NATIVE:
                            return Observable.<MjpegInputStream>just(new MjpegInputStreamNative(inputStream));
                    }
